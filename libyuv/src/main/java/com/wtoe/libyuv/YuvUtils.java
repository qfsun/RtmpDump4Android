package com.wtoe.libyuv;

public class YuvUtils {

    static {
        System.loadLibrary("yuv");
        System.loadLibrary("yuv-handle");
    }
     ...
     **/
    public static native void yuvCropI420(byte[] src, int width, int height, byte[] dst, int dst_width, int dst_height, int left, int top);
